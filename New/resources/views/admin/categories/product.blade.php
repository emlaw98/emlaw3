...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="{{ route('admin.categories.product') }}">Danh mục sản phẩm</a>
    </li>
    <li class="nav-item">
  ...
  <div class="search">
    <form action="{{ route('admin.categories.searchProductCategory') }}" method="GET" role="search">
